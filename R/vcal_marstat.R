#' @title Marital Status Calendar
#' @author Matt Gunther
#' @description Create all variables related to the Marital Status calendar
...
#' \itemize{
#'   \item{
#'     \strong{married} Logical: TRUE if \code{vcal_marstat} contains "X" or
#'     "x". FALSE if  \code{vcal_marstat} is 0. Not available if vcal_marstat
#'     is not available (NA) or any other character (e.g. " " or "?").
#'   }
#' }
