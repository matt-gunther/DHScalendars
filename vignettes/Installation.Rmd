...
This R package is available on github.umn.edu. 

Derek Burk maintains an R package called `umnstall` that makes it easy to install R packages from github.umn.edu. Follow his [instructions to install umnstall](https://github.umn.edu/burkx031/umnstall), then run this code in R:

```{r, eval = F}
umnstall::umnstall("mgunther/DHScalendars")
```
